...
public class Main {
    public static  void main (String[] args){
        ...
        app.Run();                              // das Objekt app ruft die Methode run() auf, die Methode ruft den scanner auf, initialisiert mit dem eingegebenen Wert das int-Attribut figure,
                                // figure wird in uodateState übergeben und wählt mit dem switch das entsprechende Figure-Objekt aus (=figureToPrint),
                            // das kommt dann in output, danach ist einiges unklar, z.B. wie und wann wird StringBuilder aufgerufen/ausgegeben
        input.close();      //der scanner "input" aus der Klasse App (als Parameter übergeben) ruft eine Methode close() auf. Wo finde ich die Methode?
